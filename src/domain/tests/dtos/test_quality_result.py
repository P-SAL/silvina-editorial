...
class TestQualityResultDTO(TestCase):
    def test_quality_result_is_subclass_of_base_dto(self):
        self.assertTrue(issubclass(QualityResultDTO, BaseDTO))

    def test_quality_result_is_immutable(self):
        result = QualityResultDTO(overall_score=8.5, quality_level=QualityLevel.GOOD)
    ...
    def test_dimension_scores_annotation_uses_typing_any(self):
        hints = get_type_hints(QualityResultDTO)
