...
# Stop sequences
LLM_STOP_SEQUENCES = ["\n\n\n", "\n4.", "RECOMENDACIONES", "En conclusión", "---", "==="]
...
REQUIRED_SECTIONS = {
    "introducción": {
        "order": 1,
        "min_words": 300,
        "aliases": ["introduccion", "marco teórico", "marco teorico"],
    },
    "métodos": {
        "order": 2,
        "min_words": 200,
        "aliases": ["metodos", "metodología", "metodologia", "método"],
    },
    "resultados": {
        "order": 3,
        "min_words": 300,
        "aliases": ["resultados y análisis", "resultados y analisis"],
    },
